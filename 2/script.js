      ...
      "content": [
        ...
        },
        {
          ...
          "items": [
            {
              "type": "text",
              "content": "この実験では画面の中央に赤色または黒色の数字が呈示されます。黒色の数字が呈示されている間は，反応せずに中央の数字を覚えてください。赤色の数字が呈示されたら２つ前に呈示された数字を思い出し，その数字が奇数であれば「奇キー(Fキー）」を，偶数であれば「偶キー（Jキー）」を押してください。まず，練習します。",
              "title": "まず始めに練習します。"
            }
          ],
          "scrollTop": true,
        ...
        },
        {
          ...
          "items": [
            {
              "type": "text",
              "content": "練習と同じです。この実験では画面の中央に赤色または黒色の数字が呈示されます。黒色の数字が呈示されている間は，反応せずに中央の数字を覚えてください。赤色の数字が呈示されたら２つ前に呈示された数字を思い出し，その数字が奇数であれば「奇キー(Fキー）」を，偶数であれば「偶キー（Jキー）」を押してください。まず，練習します。",
              "title": "本試行をはじめます。"
            }
          ],
          "scrollTop": true,
          ...
          "items": [
            {
              "type": "text",
              "title": "冒頭に行った，日常で使う「物」の通常とは異なる使い方を答える問題を再開します。",
              "content": "まず，段ボールの日常とは異なる使い方について，先ほどの続きから取り組んでいただきます。回答は，重複しないようにお願いします。制限時間は2分間です。"
            }
          ],
          "scrollTop": true,
          "submitButtonText": "回答を始める →",
